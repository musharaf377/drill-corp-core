...
class Blog_List_Tab extends Widget_Base
{

    public function get_name()
    {
        return 'blog-list-tab-widget';
    }

    public function get_title()
    {
        return esc_html__('Blog List Tab', 'drillcorp-core');
    }

    public function get_keywords()
    {
        return ['blog', 'list', 'tab', 'drillcorp'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control('tab_gap', [
            ...
            'default' => ['size' => 15],
            'selectors' => [
                '{{WRAPPER}} .blog-list-tab-nav' => 'gap: {{SIZE}}{{UNIT}};',
            ],
        ]);
        ...
        $this->add_responsive_control('tab_padding', [
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors'  => [
                '{{WRAPPER}} .blog-list-tab-nav-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        ...
        $this->add_responsive_control('tab_margin', [
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors'  => [
                '{{WRAPPER}} .blog-list-tab-nav-item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        ...
        $this->add_responsive_control('tab_border_radius', [
            ...
            'size_units' => ['px', '%'],
            'selectors'  => [
                '{{WRAPPER}} .blog-list-tab-nav-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        ...
        $this->add_group_control(Group_Control_Border::get_type(), [
            ...
            'selector' => '{{WRAPPER}} .blog-list-tab-nav',
        ]);
        ...
        $this->add_responsive_control('tab_nav_border_radius', [
            ...
            'size_units' => ['px', '%'],
            'selectors'  => [
                '{{WRAPPER}} .blog-list-tab-nav' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        ...
        $this->add_responsive_control('tab_nav_padding', [
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors'  => [
                '{{WRAPPER}} .blog-list-tab-nav' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        ...
        $this->add_control('tab_normal_bg', [
            ...
            'default' => '#f5f5f5',
            'selectors' => [
                '{{WRAPPER}} .blog-list-tab-nav-item' => 'background-color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_control('tab_normal_color', [
            ...
            'default' => '#333333',
            'selectors' => [
                '{{WRAPPER}} .blog-list-tab-nav-item a' => 'color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), [
            ...
            'selector' => '{{WRAPPER}} .blog-list-tab-nav-item a',
        ]);

        $this->add_group_control(Group_Control_Border::get_type(), [
            'name'     => 'tab_border',
            'label'    => esc_html__('Border', 'drillcorp-core'),
            'selector' => '{{WRAPPER}} .blog-list-tab-nav-item',
        ]);
        ...
        $this->add_control('tab_hover_bg', [
            ...
            'default' => '#e0e0e0',
            'selectors' => [
                '{{WRAPPER}} .blog-list-tab-nav-item:hover' => 'background-color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_control('tab_hover_color', [
            ...
            'default' => '#000000',
            'selectors' => [
                '{{WRAPPER}} .blog-list-tab-nav-item:hover a' => 'color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_group_control(Group_Control_Border::get_type(), [
            ...
            'label'    => esc_html__('Border', 'drillcorp-core'),
            'selector' => '{{WRAPPER}} .blog-list-tab-nav-item:hover',
        ]);
        ...
        $this->add_control('tab_active_bg', [
            ...
            'default' => '#0D1A21',
            'selectors' => [
                '{{WRAPPER}} .blog-list-tab-nav-item.active' => 'background-color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_control('tab_active_color', [
            ...
            'default' => '#ffffff',
            'selectors' => [
                '{{WRAPPER}} .blog-list-tab-nav-item.active a' => 'color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_group_control(Group_Control_Border::get_type(), [
            ...
            'label'    => esc_html__('Border', 'drillcorp-core'),
            'selector' => '{{WRAPPER}} .blog-list-tab-nav-item.active',
        ]);
        ...
        $this->add_responsive_control('container_margin', [
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors'  => [
                '{{WRAPPER}} .blog-list-container' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        ...
        if ($all_query->have_posts()) {
            while ($all_query->have_posts()) {
                ...
                foreach ($post_categories as $cat) {
                    ...
                    $posts_by_category[$cat->term_id][] = $post_id;
                }
            }
            wp_reset_postdata();
        }
...
?>
        <div class="blog-list-tab-wrap" data-widget-id="<?php echo esc_attr($unique_id); ?>">
            <div class="blog-list-tab">
                <ul class="blog-list-tab-nav">
                    <?php foreach ($categories as $cat_id => $cat_name) : ?>
                        <li class="blog-list-tab-nav-item <?php echo ($cat_id === 'all') ? 'active' : ''; ?>" data-category="<?php echo esc_attr($cat_id); ?>">
            ...
            <div class="blog-list-container">
                <div class="blog-list blog-list-content-tab" data-widget-id="<?php echo esc_attr($unique_id); ?>">
                    <?php
                    ...
                    ?>
                        <article class="blog-list-item" data-categories="<?php echo esc_attr(implode(',', wp_get_post_categories(get_the_ID(), ['fields' => 'ids']))); ?>">
